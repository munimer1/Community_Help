...
ActiveRecord::Schema.define(version: 20171206040746) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_appointments_on_email", unique: true
    t.index ["reset_password_token"], name: "index_appointments_on_reset_password_token", unique: true
  end
